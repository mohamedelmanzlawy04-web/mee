              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  {!isLoading && data?.data?.length === 0 && (
                    <tr>
                      <td colSpan={5} className="px-4 py-10 text-center font-sans text-sm text-muted-foreground">No customers found</td>
                    </tr>
                  )}
                  {data?.data?.map((c) => (
                    <tr key={c.id} className="border-b border-border/50 last:border-0 hover:bg-muted/20">
                      ...
                      <td className="px-4 py-3">
                        <span className="inline-block px-2 py-0.5 rounded-sm font-sans text-[10px] tracking-wider uppercase font-medium bg-muted text-muted-foreground">
                          {c.role}
                        </span>
                      </td>
