...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('PAYMOB', 'STRIPE', 'CASH_ON_DELIVERY');
...
-- CreateEnum
CREATE TYPE "InventoryChangeReason" AS ENUM ('PURCHASE', 'RETURN', 'ADJUSTMENT', 'RESERVATION', 'RELEASE', 'DAMAGE', 'RESTOCK');

-- CreateEnum
CREATE TYPE "ShippingCarrier" AS ENUM ('BOSTA', 'MYLERZ', 'ARAMEX', 'MANUAL');
...
-- CreateIndex
CREATE INDEX "inventories_currentStock_idx" ON "inventories"("currentStock");
...
-- AddForeignKey
ALTER TABLE "inventory_history" ADD CONSTRAINT "inventory_history_inventoryId_fkey" FOREIGN KEY ("inventoryId") REFERENCES "inventories"("id") ON DELETE CASCADE ON UPDATE CASCADE;
